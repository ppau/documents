...
\begin{enumerate}
\item Unless otherwise provided within this constitution, no question regarding Party business is to be decided or resolved at a meeting of the National Council unless at least two thirds of the National Council are present.
\begin{enumerate}
\item Voting requirements for majorities are taken to mean the entire membership of the National Council.
\item Quorum may be considered to have been reached where express written consent is given on any particular issue by the member of the National Council.
\begin{enumerate}
...
\subsubsubsection{Duties and Responsibilities}
...
\begin{enumerate}
\item The Treasurer will fulfil the requirements and obligations of the Public Officer as defined in the NSW Associations Incorporation Act 2009.
